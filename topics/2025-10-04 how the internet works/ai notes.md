...
<table style="font-size: 0.85em; line-height: 1.0;">
  ...
  <tr>
    ...
    <td style="padding: 2px;">2025-10-04</td>
  </tr>
  <tr>
    <td style="padding: 2px;"><strong>Presenters</strong></td>
    <td style="padding: 2px;">Chris</td>
  </tr>
  <tr>
...
* **IP Address Assignment and DHCP Process:** Chris led a detailed explanation of how a computer obtains an IP address via DHCP, describing the process from initial connection to network configuration, and discussed related concepts with the group including Haddon and Dan.
