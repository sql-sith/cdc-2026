...
# Python Bootcamp (Week 2)

## Installing VSCode and its main Python Extensions

Sometimes things don't go as planned. We had hoped to do more this week, but we had some trouble getting Python to work correctly in VSCode until Dan realized that Haddon might not be on the same computer he had been the week before. Dan's intuition was correct! The problem was that Python was not installed on the computer Haddon was using. Live and learn. :)
