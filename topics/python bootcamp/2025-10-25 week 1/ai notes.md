...
<table style="font-size: 0.85em; line-height: 1.0;">
  ...
  <tr>
    ...
    <td style="padding: 2px;">2025-10-25</td>
  </tr>
  <tr>
...
## Intro to the Python language and REPL environment

* **Introduction to Python for Cyber Defense:** Chris led a session introducing Python programming, focusing on data types, the REPL environment, and the language's advantages for rapid iteration, with active participation from Dan and Haddon.

  * **Python's Role in Cyber Defense:** Chris explained that Python is widely used due to its ease of use, and interpreted nature, which makes for rapid prototyping and iteration. This makes it a popular in many technical areas, including cyber security professionals.
  * **REPL Environment and Data Types:** Chris demonstrated the Python REPL (Read-Evaluate-Print Loop) environment, showing how it interprets commands interactively, and discussed Python's dynamic typing system (duck typing), where the type of a variable is inferred at runtime.
...
* **Input and Output in Python Scripts:** Chris guided Dan and Haddon through Python's input and output mechanisms, including the use of print statements, input prompts, and differences between interactive and script-based execution.
